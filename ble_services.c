...
#define DEVICE_NAME                     "PSens"                                /**< Name of device. Will be included in the advertising data. */
...
static void on_cus_evt(ble_cus_t * p_bas, ble_cus_evt_t * p_evt)
{
  ...
  switch(p_evt->evt_type)
  {
    ...
    case BLE_CUS_EVT_HUMIDITY_NOTIFICATION_ENABLED:
      update_sensor_characteristic_start(HUMIDITY_SENSOR);
      break;
    ...
    case BLE_CUS_EVT_SOIL_NOTIFICATION_ENABLED:
      update_sensor_characteristic_start(SOIL_SENSOR);
      break;

    case BLE_CUS_EVT_LIGHT_NOTIFICATION_ENABLED:
      update_sensor_characteristic_start(LIGHT_SENSOR);
      break;
    ...
    case BLE_CUS_EVT_HUMIDITY_NOTIFICATION_DISABLED:
      update_sensor_characteristic_stop(HUMIDITY_SENSOR);
      break;
    ...
    case BLE_CUS_EVT_SOIL_NOTIFICATION_DISABLED:
      update_sensor_characteristic_stop(SOIL_SENSOR);
      break;

    case BLE_CUS_EVT_LIGHT_NOTIFICATION_DISABLED:
      update_sensor_characteristic_stop(LIGHT_SENSOR);
      break;
...
void services_init(void)
{
  ...
  /* Humidity */
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.humidity_char_attr_md.cccd_write_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.humidity_char_attr_md.read_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.humidity_char_attr_md.write_perm);
  ...
  /* Soil */
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.soil_char_attr_md.cccd_write_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.soil_char_attr_md.read_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.soil_char_attr_md.write_perm);

  /* Light */
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.light_char_attr_md.cccd_write_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.light_char_attr_md.read_perm);
  BLE_GAP_CONN_SEC_MODE_SET_OPEN(&cus_init.light_char_attr_md.write_perm);
...
void update_sensors_service(sensor_t sensor_id)
{
  ...
  {
    case BATTERY_SENSOR:
      err_code = ble_cus_soil_update(&ble_cus, soil);
    ...
    case HUMIDITY_SENSOR:
      err_code = ble_cus_humidity_update(&ble_cus, humidity);
      APP_ERROR_CHECK(err_code);
      break;

    case SALINITY_SENSOR:
      err_code = ble_cus_salinity_update(&ble_cus, humidity);
      APP_ERROR_CHECK(err_code);
      break;

    case SOIL_SENSOR:
      err_code = ble_cus_soil_update(&ble_cus, salinity);
      APP_ERROR_CHECK(err_code);
      break;

    case LIGHT_SENSOR:
      err_code = ble_cus_light_update(&ble_cus, light);
      APP_ERROR_CHECK(err_code);
      break;
  }
